...
namespace EV3.Dev.Csharp.Motors
{
    ...
    public class Motor : Device
    {
        ...
        {
            string classDir = System.IO.Path.Combine(SysRoot, "class", "tacho-motor");
        ...
        /// Run the motor until another command is sent.
        /// </summary>        
        public void RunForever() { Command = CommandRunForever; }

        /// <summary> 
        /// Run to an absolute position specified by `position_sp` and then
        /// stop using the command specified in `stop_command`.
        /// </summary>        
        public void RunToAbsPos() { Command = CommandRunToAbsPos; }
        ...
        /// the command specified by `stop_command`.
        /// </summary>        
        public void RunToRelPos() { Command = CommandRunToRelPos; }

        /// <summary> 
        /// Run the motor for the amount of time specified in `time_sp`
        /// and then stop the motor using the command specified by `stop_command`.
        /// </summary>        
        public void RunTimed() { Command = CommandRunTimed; }
        ...
        /// take effect immediately.
        /// </summary>        
        public void RunDirect() { Command = CommandRunDirect; }

        /// <summary> 
        /// Stop any of the run commands before they are complete using the
        /// command specified by `stop_command`.
        /// </summary>        
        public void Stop() { Command = CommandStop; }

        /// <summary> 
        /// Reset all of the motor parameter attributes to their default value.
        /// This will also have the effect of stopping the motor.
        /// </summary>        
        public void Reset() { Command = CommandReset; }
